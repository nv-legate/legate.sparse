...
/* static */ void AddCSRCSRNNZ::cpu_variant(TaskContext& context)
{
  add_csr_csr_nnz_template<VariantKind::CPU>(context);
}

/* static */ void AddCSRCSR::cpu_variant(TaskContext& context)
{
  add_csr_csr_template<VariantKind::CPU>(context);
}
...
{
  AddCSRCSRNNZ::register_variants();
  AddCSRCSR::register_variants();
}
}  // namespace

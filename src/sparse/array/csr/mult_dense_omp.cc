...
struct ElemwiseMultCSRDenseArgsImplBody<VariantKind::OMP, INDEX_CODE, VAL_CODE> {
...
/*static*/ void ElemwiseMultCSRDense::omp_variant(TaskContext& context)
{
  elemwise_mult_dense_template<VariantKind::OMP>(context);
}

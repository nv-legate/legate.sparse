...
struct CSRTropicalSpMVImplBody<VariantKind::OMP, INDEX_CODE> {
...
/*static*/ void CSRTropicalSpMV::omp_variant(TaskContext& context)
{
  csr_tropical_spmv_template<VariantKind::OMP>(context);
}

...
struct CSCSpMVColSplitImplBody<VariantKind::OMP, INDEX_CODE, VAL_CODE, ACC> {
...
/*static*/ void CSCSpMVColSplit::omp_variant(TaskContext& context)
{
  csc_spmv_col_split_template<VariantKind::OMP>(context);
}

...
struct DenseToCSCNNZImplBody<VariantKind::OMP, VAL_CODE> {
...
struct DenseToCSCImplBody<VariantKind::OMP, INDEX_CODE, VAL_CODE> {
...
/*static*/ void DenseToCSCNNZ::omp_variant(TaskContext& context)
{
  dense_to_csc_nnz_template<VariantKind::OMP>(context);
}

/*static*/ void DenseToCSC::omp_variant(TaskContext& context)
{
  dense_to_csc_template<VariantKind::OMP>(context);
}

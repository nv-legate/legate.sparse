...
struct CSCToDenseImplBody<VariantKind::OMP, INDEX_CODE, VAL_CODE> {
...
/*static*/ void CSCToDense::omp_variant(TaskContext& context)
{
  csc_to_dense_template<VariantKind::OMP>(context);
}

...
struct BoundsFromPartitionedCoordinatesImplBody<VariantKind::OMP, INDEX_CODE> {
...
/*static*/ void BoundsFromPartitionedCoordinates::omp_variant(TaskContext& context)
{
  bounds_from_partitioned_coordinates_template<VariantKind::OMP>(context);
}

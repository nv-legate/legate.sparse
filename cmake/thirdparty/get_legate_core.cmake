...
if(NOT DEFINED legate_sparse_LEGATE_CORE_REPOSITORY)
  set(legate_sparse_LEGATE_CORE_REPOSITORY https://github.com/nv-legate/legate.core.git)
endif()

find_or_configure_legate_core(VERSION          ${legate_sparse_VERSION}
                              REPOSITORY       ${legate_sparse_LEGATE_CORE_REPOSITORY}
                              BRANCH           ${legate_sparse_LEGATE_CORE_BRANCH}
                              EXCLUDE_FROM_ALL ${legate_sparse_EXCLUDE_LEGATE_CORE_FROM_ALL}
)

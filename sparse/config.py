...
class SparseOpCode(IntEnum):
    ...
    CSR_SPMV_ROW_SPLIT_COLLECTIVE = _sparse.LEGATE_SPARSE_CSR_SPMV_ROW_SPLIT_COLLECTIVE
    CSR_SPMV_ROW_SPLIT_EXPLICIT_COLLECTIVE = _sparse.LEGATE_SPARSE_CSR_SPMV_ROW_SPLIT_EXPLICIT_COLLECTIVE
